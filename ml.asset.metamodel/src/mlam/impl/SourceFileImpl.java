 ...
 * </p>
 * <ul>
 *   <li>{@link mlam.impl.SourceFileImpl#getDtype <em>Dtype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceFileImpl extends MinimalEObjectImpl.Container implements SourceFile {
	...
	protected EClass eStaticClass() {
		return MlamPackage.Literals.SOURCE_FILE;
	}
	...
	public EList<String> getDtype() {
		if (dtype == null) {
			dtype = new EDataTypeUniqueEList<String>(String.class, this, MlamPackage.SOURCE_FILE__DTYPE);
		}
		return dtype;
	}
