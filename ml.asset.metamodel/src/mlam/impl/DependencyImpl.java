 ...
 * </p>
 * <ul>
 *   <li>{@link mlam.impl.DependencyImpl#getDtype <em>Dtype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependencyImpl extends MinimalEObjectImpl.Container implements Dependency {
	...
	protected EClass eStaticClass() {
		return MlamPackage.Literals.DEPENDENCY;
	}
	...
	public void setDtype(String newDtype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlamPackage.DEPENDENCY__DTYPE, oldDtype, dtype));
	}
