...
/**
 * This is the item provider adapter for a {@link mlam.Metrics} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetricsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metrics_dtype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metrics_dtype_feature", "_UI_Metrics_type"),
				 MlamPackage.Literals.METRICS__DTYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		return getString("_UI_Metrics_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Metrics.class)) {
			case MlamPackage.METRICS__DTYPE:
