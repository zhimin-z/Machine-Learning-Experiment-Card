...
/**
 * This is the item provider adapter for a {@link mlam.Log} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogItemProvider extends DocumentationItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MlamPackage.Literals.LOG__METRICS);
			childrenFeatures.add(MlamPackage.Literals.LOG__EXECUTION_DATA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MlamPackage.Literals.LOG__METRICS,
				 MlamFactory.eINSTANCE.createMetrics()));

		newChildDescriptors.add
			(createChildParameter
				(MlamPackage.Literals.LOG__EXECUTION_DATA,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == MlamPackage.Literals.DATA__FEATURE ||
			childFeature == MlamPackage.Literals.LOG__EXECUTION_DATA;
