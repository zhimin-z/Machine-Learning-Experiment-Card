...
/**
 * This is the item provider adapter for a {@link mlam.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_dtype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_dtype_feature", "_UI_Dependency_type"),
				 MlamPackage.Literals.DEPENDENCY__DTYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Dependency)object).getDtype();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dependency.class)) {
			case MlamPackage.DEPENDENCY__DTYPE:
