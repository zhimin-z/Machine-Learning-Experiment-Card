...
/**
 * This is the item provider adapter for a {@link mlam.Dataset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatasetItemProvider extends DataItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dataset_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dataset_data_feature", "_UI_Dataset_type"),
				 MlamPackage.Literals.DATASET__DATA,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dataset.class)) {
			case MlamPackage.DATASET__DATA:
